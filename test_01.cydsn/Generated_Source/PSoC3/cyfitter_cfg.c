...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x00080000u)

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x00080008u)
...
static void ClockSetup(void)
{
	...
	CY_SET_REG8((void CYXDATA *)(CYREG_CLKDIST_CR), 0x01u);
	...
	CY_SET_REG8((void CYXDATA *)(CYREG_CLKDIST_CR), 0x41u);

	/* Configure IMO based on settings from Clock DWR */
	CY_SET_REG8((void CYXDATA *)(CYREG_FASTCLK_IMO_CR), 0x20u);
