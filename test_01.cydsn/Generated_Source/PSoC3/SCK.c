...
{
    uint8 staticBits = (SCK_DR & (uint8)(~SCK_MASK));
    SCK_DR = staticBits | ((uint8)(value << SCK_SHIFT) & SCK_MASK);
}
...
*
*  SCK_DM_STRONG     Strong Drive 
*  SCK_DM_OD_HI      Open Drain, Drives High 
*  SCK_DM_OD_LO      Open Drain, Drives Low 
*  SCK_DM_RES_UP     Resistive Pull Up 
*  SCK_DM_RES_DWN    Resistive Pull Down 
*  SCK_DM_RES_UPDWN  Resistive Pull Up/Down 
*  SCK_DM_DIG_HIZ    High Impedance Digital 
*  SCK_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
