// ======================================================================
// test_01.v generated from TopDesign.cysch
// 09/19/2018 at 02:39
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("74448a3d-bfc7-4155-b83b-ec174a2a1c9c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__RCK_net;
	wire [0:0] tmpFB_0__RCK_net;
	wire [0:0] tmpIO_0__RCK_net;
	wire [0:0] tmpINTERRUPT_0__RCK_net;
	electrical [0:0] tmpSIOVREF__RCK_net;

	cy_psoc3_pins_v1_10
		#(.id("1bb4f96f-2ef3-4c8f-9dd1-75c4813d3494"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		RCK
		 (.oe(tmpOE__RCK_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RCK_net[0:0]}),
		  .io({tmpIO_0__RCK_net[0:0]}),
		  .siovref(tmpSIOVREF__RCK_net),
		  .interrupt({tmpINTERRUPT_0__RCK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RCK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
